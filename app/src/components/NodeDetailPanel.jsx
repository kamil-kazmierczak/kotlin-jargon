...
export default function NodeDetailPanel({
  ...
  return (
    <aside
      aria-label={`${term.title} concept`}
      className={`fixed inset-y-0 right-0 w-[500px] lg:w-[560px] backdrop-blur-md border-l z-50 flex flex-col font-mono shadow-2xl transition-transform duration-300 ease-[var(--ease-out-expo)] ${
        isDark
