...
or `unresolved-reference`) rather than a fragile full compiler message. `fragment` and
`pseudocode` are intentionally excluded; they need no identity or source filename.
